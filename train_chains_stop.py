"""
Training script for the STOP Token Experiment.

Same architecture and training loop as train_chains.py, but uses the
STOP-aware evaluator and points to the STOP experiment config/data.
"""
    ...
    def on_validation_epoch_end(self):
        ...
        try:
            with open(test_file, "r") as f:
                raw = json.load(f)
            # Extended format uses "letters" and "decision_funcs" fields
...
def main(cfg: DictConfig):
    ...
    # Verify STOP token is in vocabulary
